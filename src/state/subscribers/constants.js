...
export const REQUEST_EDIT_SUBSCRIBER = makeConstant(STATE_BRANCH, 'REQUEST_EDIT_SUBSCRIBER');
export const UPDATE_SUBMIT_BUTTON_TEXT = makeConstant(STATE_BRANCH, 'UPDATE_SUBMIT_BUTTON_TEXT');